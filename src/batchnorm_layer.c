...
{
    printf("forward_batchnorm_layer, l.type = %d, net.train = %d\n", l.type, net.train);
    ...
    if(net.train){
...

        {
            ...
            sprintf(buffer, "yolo_cpu_rolling_mean_b_%d_%dx%dx%d.bin", l.batch, l.out_c, l.out_h, l.out_w);
            fp = fopen(buffer, "wb");
            if(NULL == fp)
            {
                printf("yolo_cpu_rolling_mean open error\n");
            }
            fwrite(l.rolling_mean, l.out_c, sizeof(float), fp);
            fclose(fp);
        }          
        {
            FILE *fp;
            ...
            sprintf(buffer, "yolo_cpu_rolling_variance_b_%d_%dx%dx%d.bin", l.batch, l.out_c, l.out_h, l.out_w);
            fp = fopen(buffer, "wb");
            if(NULL == fp)
            {
                printf("yolo_cpu_rolling_variance open error\n");
            }
            fwrite(l.rolling_variance, l.out_c, sizeof(float), fp);
            fclose(fp);
        }          
    }
    ...
    add_bias(l.output, l.biases, l.batch, l.out_c, l.out_h*l.out_w);
    {
        ...
        sprintf(buffer, "yolo_cpu_scales_b_%d_%dx%dx%d.bin", l.batch, l.out_c, l.out_h, l.out_w);
        fp = fopen(buffer, "wb");
        if(NULL == fp)
        {
            printf("yolo_cpu_scales open error\n");
        }
        fwrite(l.scales, l.out_c, sizeof(float), fp);
        fclose(fp);
    }          
    {
        FILE *fp;
        ...
        sprintf(buffer, "yolo_cpu_biases_b_%d_%dx%dx%d.bin", l.batch, l.out_c, l.out_h, l.out_w);
        fp = fopen(buffer, "wb");
        if(NULL == fp)
        {
            printf("yolo_cpu_biases open error\n");
        }
        fwrite(l.biases, l.out_c, sizeof(float), fp);
        fclose(fp);
    }          
}
